  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <p className={styles.description}>توضیح کوتاه یا شعار کوتاه به زودی قرار میگیرد...</p>
      ...
      <main className={styles.main}>
        <Link href={`/blog/detail`} passHref>
          <section className={styles.featured}>
            ...
            <div className={styles.featuredContent}>
              ...
              <h2 className={styles.featuredTitle}>چگونه دوچرخه مناسب برای بهار انتخاب کنیم؟</h2>
        ...
        <section className={styles.articles}>
          {[
            ...
            <Link href={`/blog/detail`} key={index} passHref>
              <article key={index} className={styles.article}>
                ...
                <div className={styles.articleContent}>
                  <span className={`${styles.label} ${styles[item.className]}`}>{item.tag}</span>
