...
export default function shoppingStage8() {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        <h2 className={styles.title}>ارسال پستی مدارک و اطلاعات</h2>
        ...
        <div className={styles.alert}>
          لطفا مدارک دریافتی، امضا شده و اثرانگشت خورده را به آدرس زیر پست نمایید
        </div>
