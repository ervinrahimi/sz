...
export default function shoppingStage6() {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        <h2 className={styles.title}>دریافت شناسه وجه پرداخت</h2>
        ...
        <div className={styles.formContainer}>
          <form onSubmit={handleSubmit} className={styles.uploadForm}>
            <label className={styles.label}>بارگذاری فیش واریزی حین ثبت نام</label>
            <input
              type="file"
