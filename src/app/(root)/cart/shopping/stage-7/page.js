...
export default function shoppingStage7() {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        <h2 className={styles.title}>فایل نهایی قرارداد + فرم نهایی اطلاعات</h2>

        <button onClick={handleToast} className={styles.downloadButton}>
          دانـــلود قـــرارداد
        </button>
        <button onClick={handleToast} className={styles.downloadButton}>
          دانلود فرم اطلاعات
        </button>
        ...
        <div className={styles.alert}>
          توجه: لطفا از مدارک پرینت بگیرید، فیلدهای مربوطه را پر کنید و امضا/اثر انگشت بزنید
        </div>
        <div className={styles.formContainer}>
          <form onSubmit={handleSubmit} className={styles.uploadForm}>
            <label className={styles.label}>بارگذاری فایل قرارداد امضا/اثرانگشت شده</label>
            <input
              type="file"
              ...
              multiple
            />
            <label className={styles.label}>بارگذاری فرم اطلاعات امضا/اثرانگشت شده</label>
            <input
              type="file"
              onChange={handleFileChange1}
              className={styles.inputFile}
              ...
              multiple
            />
            <label className={styles.label}>بارگذاری گواهی امضای دفترخانه</label>
            <input
              type="file"
              onChange={handleFileChange1}
              className={styles.inputFile}
